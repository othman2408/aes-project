...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        nav.addItem(new SideNavItem("Text Encryption", TextEncryptionView.class,
                LineAwesomeIcon.TEXT_WIDTH_SOLID.create()));
        nav.addItem(new SideNavItem("Text Decryption", TextDecryptionView.class,
                LineAwesomeIcon.TEXT_WIDTH_SOLID.create()));
